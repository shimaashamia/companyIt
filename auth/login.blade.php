            ...
            <!-- <div class="card"> -->
                ...
                <!-- <div class="card-body"> -->
					...
					<span class="login">
						...
						<input id="email"  class="input100" type="email" name="email" placeholder="Username or email" value="{{ old('email') }}"  >
                        @error('email')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                        ...
                        <div class="exiting">
			           <span>New User?</span> <a href="register" class="txt3">Sign Up</a>
                       </div>
                        </div>   
